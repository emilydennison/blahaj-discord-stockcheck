...
def main():
    ...
    for maybeShonk  in range(1, 3):
        ...
        big_availabilities = requests.get("https://api.ingka.ikea.com/cia/availabilities/ru/gb?itemNos=" + shorkType + "&expand=StoresList,Restocks,SalesLocations", headers={
...
def send_webhook(sharks, shorkName):
    hook = webhook.SyncWebhook.from_url(
        "#TODO INSERT YOUR OWN WEBHOOK HERE.")
    messageEmbeds = [
        embeds.Embed(
    ...
    # Break up the message into two chunks (embed char limit) 
